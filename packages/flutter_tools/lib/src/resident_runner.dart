  ...
  static Future<FlutterDevice> create(
    ...
    if (targetPlatform == TargetPlatform.web_javascript) {
      ...
      final List<String> extraFrontEndOptions =
          List<String>.of(buildInfo.extraFrontEndOptions ?? <String>[]);
      ...
      generator = ResidentCompiler(
        ...
        extraFrontEndOptions: extraFrontEndOptions,
        platformDill: globals.fs
            .file(globals.artifacts.getHostArtifact(platformDillArtifact))
            .absolute
            .uri
            .toString(),
        dartDefines: buildInfo.dartDefines,
...
abstract class ResidentHandlers {
  ...
  Future<String> writeSkSL() async {
    ...
    final Map<String, Object> data =
        await flutterDevices.first.vmService.getSkSLs(
...
abstract class ResidentRunner extends ResidentHandlers {
  ...
  Future<void> shutdownDartDevelopmentService() async {
    await Future.wait<void>(flutterDevices
        .map<Future<void>>(
...
class OperationResult {
  OperationResult(this.code, this.message,
      {this.fatal = false, this.updateFSReport});
