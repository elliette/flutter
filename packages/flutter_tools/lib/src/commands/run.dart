...
abstract class RunCommandBase extends FlutterCommand
  ...
  Future<DebuggingOptions> createDebuggingOptions(bool webMode) async {
    ...
    final int browserDebugPort = featureFlags.isWebEnabled &&
...
class RunCommand extends RunCommandBase {
  ...
  Future<FlutterCommandResult> runCommand() async {
    ...
    try {
      // ELLIOTT: HERE IS WHERE WE START RUNNING AND DETERMINE WHETHER TO ENABLE DEVTOOLS
      print('stay resident $stayResident');
      print('kEnableDevTools ${boolArg(FlutterCommand.kEnableDevTools)}');
